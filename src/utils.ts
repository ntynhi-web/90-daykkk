...
function applyConfirmedPersonalPlan(state: AppState): AppState {
  ...
  return {
    ...
    b2bLeads: state.b2bLeads || [], jobApplications: state.jobApplications || [], healthRecords: state.healthRecords || {}, lifestyleRecords: state.lifestyleRecords || {},
    batchTestRecords: state.batchTestRecords || [], evidenceRecommendations: state.evidenceRecommendations || [], aiChangeHistory: state.aiChangeHistory || [], coachHistory: state.coachHistory || [],
...
// Return a clean clone without embedded lead, health, trading, or account records.
